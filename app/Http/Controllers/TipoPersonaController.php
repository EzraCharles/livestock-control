...
class TipoPersonaController extends Controller
{
     ...
     *
     * @param  \App\TipoPersona  $tipo_persona
     * @return \Illuminate\Http\Response
     */
    public function restore(Request $request)
    {
        try {
            $tipo_persona = \App\TipoPersona::withTrashed()->find($request['input'])->restore();
    ...
    {
        try {
            $tipo_persona = \App\TipoPersona::withTrashed()->find($request['input'])->forceDelete();
            echo json_encode('success');
        } catch (\Throwable $th) {
            echo json_encode('error');
        }
