...
<main class="main">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3> <strong> Tipos de Alimetación </strong></h3>
                            <div class="col-md-12" style="padding-top: 15px; ">
                                <button class="btn grupo-res" id="add" style="text-align: left; float: right; margin-top: -50px;">Añadir Tipo de Alimentación</button>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="content">
                                <div id="add-item" class="row col-md-12" style="padding-top: 15px;">
                                    <div class="col-6">
                                        <h5>Añadir Tipo de Alimentación</h5>
                                    </div>
                                    <div class="col-12">
                                        <form id="create" action="{{ route('tipo-alimentaciones.store') }}" method="POST" style="padding:5px;">
                                            @method('POST')
                                            @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" align="center"><b>Editar Tipo de Alimentación</b></h4>
    ...
    <div class="modal fade" id="delete-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" align="center"><b>Borrar Tipo de Alimentación</b></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#add').on('click', function () {
            ...
            if ($(this).text() == 'Cancelar') {
                $(this).text('Añadir Tipo de Alimentación');
                $('#hr-divisor').hide();
            }
            else{
                $(this).text('Cancelar');
        ...
        */
        ...
        $('#delete-modal').on('show.bs.modal', function() {
            ...
            $("#delete-form").attr('action', 'tipo-alimentaciones/' + id[0]['innerHTML']);
