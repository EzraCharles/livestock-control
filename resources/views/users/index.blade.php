            ...
            <div class="modal-body">
                <form role="form" action="edituser" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="modal-input-employee">Número de empleado</label>
    ...
    $(document).ready(function() {
        ...
        */
        ...
        $('#edit-modal').on('show.bs.modal', function() {
            ...
            var workshift = row.children("#workshift");
            //var storagefloor = row.children("#storagefloor");

            var role = row.children("#role");
            ...
            $("#modal-input-role").val(role[0]['innerHTML']);
        });
        ...
        $('#delete-modal').on('show.bs.modal', function() {
            ...
            $("#modal-input-role-delete").val(role[0]['innerHTML']);
