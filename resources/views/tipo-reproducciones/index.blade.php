                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3> <strong> Tipos de Reproducción </strong></h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="content">
                                <div id="add-item" class="row col-md-12" style="padding-top: 15px;">
                                    <div class="col-6">
                                        <h5>Añadir Tipo de Reproducción</h5>
                                    </div>
                                    <div class="col-12">
                                        <form id="create" action="{{ route('tipo-reproducciones.store') }}" method="POST" style="padding:5px;">
                                            @method('POST')
                                            @csrf
                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="display table table-striped table-hover table-condensed" style="text-align: center; vertical-align: middle; margin-bottom: 0px;">
                                    ...
                                    <tbody>
                                        @foreach ($tipo_reproducciones as $tipo_reproduccio)
                                        <tr class="data-row">
                                            <td style="text-align: center; vertical-align: middle; " id="id">{{ $tipo_reproduccio->id }}</td>
                                            <td style="text-align: center; vertical-align: middle; " id="nombre">{{ $tipo_reproduccio->nombre }}</td>
                                            <td style="text-align: center; vertical-align: middle; " id="comentarios">{{ $tipo_reproduccio->comentarios }}</td>
                                            <td style="text-align: center; vertical-align: middle; " id="created_at">{{ $tipo_reproduccio->created_at }}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ url('tipo-reproducciones/'.$tipo_reproduccio->id) }}" style="color: inherit;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" align="center"><b>Editar Tipo de Reproducción</b></h4>
    ...
    $(document).ready(function() {
        ...
        */
        ...
        $('#edit-modal').on('show.bs.modal', function() {
            ...
            $("#edit-form").attr('action', 'tipo-reproducciones/' + id[0]['innerHTML']);
        });
        ...
        $('#delete-modal').on('show.bs.modal', function() {
            ...
            $("#delete-form").attr('action', 'tipo-reproducciones/' + id[0]['innerHTML']);
